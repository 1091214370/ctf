...
function loadCubeMap(shang,xia,zuo,you,qian,hou)
{
	...
	var faces = [[you, gl.TEXTURE_CUBE_MAP_POSITIVE_X],
				 [zuo, gl.TEXTURE_CUBE_MAP_NEGATIVE_X],
				 [shang, gl.TEXTURE_CUBE_MAP_POSITIVE_Y],
				 [xia, gl.TEXTURE_CUBE_MAP_NEGATIVE_Y],
				 [qian, gl.TEXTURE_CUBE_MAP_POSITIVE_Z],
				 [hou, gl.TEXTURE_CUBE_MAP_NEGATIVE_Z]];
...
function webGLStart(shang,xia,zuo,you,qian,hou)
{
	...
	cubemap = loadCubeMap(shang,xia,zuo,you,qian,hou);
