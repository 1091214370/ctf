...
function loadCubeMap(base)
{
	...
	var faces = [["you.jpg", gl.TEXTURE_CUBE_MAP_POSITIVE_X],
				 ["zuo.jpg", gl.TEXTURE_CUBE_MAP_NEGATIVE_X],
				 ["shang.jpg", gl.TEXTURE_CUBE_MAP_POSITIVE_Y],
				 ["xia.jpg", gl.TEXTURE_CUBE_MAP_NEGATIVE_Y],
				 ["qian.jpg", gl.TEXTURE_CUBE_MAP_POSITIVE_Z],
				 ["hou.jpg", gl.TEXTURE_CUBE_MAP_NEGATIVE_Z]];
